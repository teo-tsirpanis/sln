...
namespace EnricoSada.MSBuild.Construction
{
    /// <remarks>
    ...
    public sealed class SolutionFile
    {
        ...
        internal void ParseEtpProject(ProjectInSolution etpProj)
        {
            ...
            catch (SecurityException e)
            {
                // Log a warning
                string errorCode;
                string warning = ResourceUtilities.FormatResourceString(out errorCode, out _, "Shared.ProjectFileCouldNotBeLoaded",
            ...
            catch (XmlException e)
            {
                // Log a warning
                string errorCode;
                string warning = ResourceUtilities.FormatResourceString(out errorCode, out _, "Shared.InvalidProjectFile",
                   etpProj.RelativePath, e.Message);
                _solutionParserWarnings.Add(warning);
                _solutionParserErrorCodes.Add(errorCode);
            }
